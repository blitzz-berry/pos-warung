...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.blitzzberry.warungpos'),
     ...
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'Blitzz Berry'),

    /**
     * The copyright notice for your application.
     */
    'copyright' => env('NATIVEPHP_APP_COPYRIGHT', 'Copyright '.date('Y').' Blitzz Berry'),

    /**
     * The description of your application.
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Aplikasi POS warung berbasis Laravel.'),

    /**
     * The Website of your application.
     */
    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://github.com/blitzz-berry/pos-warung'),
